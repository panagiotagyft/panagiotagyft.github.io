...
const translations = {
  en: {
    ...
    sourcesList: [
      ...
      { name: "React DOM Documentation", link: "https://react.dev/" },
      { name: "Material UI Documentation", link: "https://mui.com/" },
      { name: "MUI Icons Material Documentation", link: "https://mui.com/material-ui/material-icons/" },
      { name: "Emotion (React & Styled) Documentation", link: "https://emotion.sh/docs/introduction" },
      { name: "React Router DOM Documentation", link: "https://reactrouter.com/en/main" },
      { name: "React Bootstrap Documentation", link: "https://react-bootstrap.github.io/" },
      { name: "React Icons Documentation", link: "https://react-icons.github.io/react-icons/" },
      { name: "Bootstrap Documentation", link: "https://getbootstrap.com/" },
      { name: "React World Flags Documentation", link: "https://github.com/JohnRDOrazio/react-world-flags" },
      { name: "Country Flag Icons Documentation", link: "https://github.com/lipis/flag-icon-css" },
      { name: "Testing Library Documentation", link: "https://testing-library.com/docs/react-testing-library/intro/" },
      { name: "Web Vitals Documentation", link: "https://github.com/GoogleChrome/web-vitals" },
      { name: "MDN Docs on SVG", link: "https://developer.mozilla.org/en-US/docs/Web/SVG" },
      { name: "W3C SVG Specification", link: "https://www.w3.org/TR/SVG2/" }
    ],
